...
procedure TqrpNotaServiceObject.Executes(AServiceSeq:integer;isEstimasi:boolean=false);
...
procedure TqrpNotaServiceObject.SetDetailAll(ANomor:integer;ANama:WideString;ACode:string;AQty,APrice,AAMount,ADisc:real;AType:string;
              aItemId,aServiceParent:integer;aShipType:string;isKsg:boolean;satuan:string);
begin
  qrlNomor.Font.Style  := [];
  qrlQty.Font.Style    := [];
...
procedure TqrpNotaServiceObject.QRDBText11Print(sender: TObject;
  var Value: String);
begin
