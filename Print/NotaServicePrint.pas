...
type
  TqrpNotaService = class(TQuickRep)
    TitleBand1: TQRBand;
...
var
  qrpNotaService: TqrpNotaService;
...
procedure TqrpNotaService.Executes(AShipID: integer;APurpose:string);
var vTitle : string;
begin
  masterId := AShipId;
...
function TqrpNotaService.LoadData: boolean;
begin
...
procedure TqrpNotaService.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TqrpNotaService.QuickRepNeedData(Sender: TObject;
...
procedure TqrpNotaService.qrlTotalPrint(sender: TObject;
  var Value: String);
begin
