...
type
  TqrpSalesServiceGlobal = class(TQuickRep)
    TitleBand1: TQRBand;
...
var
  qrpSalesServiceGlobal: TqrpSalesServiceGlobal;
...
procedure TqrpSalesServiceGlobal.Executes(AGrid: TAdvStringGrid;APurpose:string);
begin
...
procedure TqrpSalesServiceGlobal.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  i:= 1;
end;
...
procedure TqrpSalesServiceGlobal.setDetailItem(ARow: integer);
begin
  ...
  qrl5.Caption := MasterGrid.StrippedCells[colgNett,aRow];
...
procedure TqrpSalesServiceGlobal.QuickRepNeedData(Sender: TObject;
