...
procedure TqrpLapClaim.Executes(AGrid: TAdvStringGrid;APurpose:string);
begin
  ...
  qrlTitle.Caption := 'Laporan Claim & Pelunasan Rubbing';
  ReportTitle := qrlTitle.Caption;
  PreviewModal;
end;

procedure TqrpLapClaim.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  i:= 1;
end;
...
procedure TqrpLapClaim.QuickRepNeedData(Sender: TObject;
  var MoreData: Boolean);
begin
  MoreData := i < MasterGrid.RowCount-1;
  if MoreData then begin
    qrl0.Caption := MasterGrid.Cells[colcNo,i];
    qrl1.Caption := MasterGrid.Cells[colcTgl,i];
    qrl2.Caption := MasterGrid.Cells[colcKet,i];
    qrl3.Caption := MasterGrid.Cells[colcNoPart,i];
    qrl4.Caption := MasterGrid.Cells[colcNama,i];
    qrl5.Caption := MasterGrid.Cells[colcCair,i];
    qrl6.Caption := MasterGrid.Cells[colcPriceList,i];
    qrl7.Caption := MasterGrid.Cells[colcHpp,i];
    qrl8.Caption := MasterGrid.Cells[colcQty,i];
    qrl9.Caption := MasterGrid.Cells[colcPPG,i];
...
procedure TqrpLapClaim.SummaryBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlSumCair.Caption := MasterGrid.Cells[colCCair,MasterGrid.rowCount-1];
  qrlSUmHPP.Caption := MasterGrid.Cells[colCHPp,MasterGrid.rowCount-1];
end;
