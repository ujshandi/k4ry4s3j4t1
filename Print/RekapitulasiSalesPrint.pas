...
type
  TqrpRekapitulasiSales = class(TQuickRep)
    TitleBand1: TQRBand;
...
var
  qrpRekapitulasiSales: TqrpRekapitulasiSales;
...
procedure TqrpRekapitulasiSales.Executes(AGrid: TAdvStringGrid;APurpose:string);
begin
  ...
  qrlTitle.Caption := IfThen(Apurpose=SHIP_TYPE_SALES,'Rekapitulasi Sales',IfThen(Apurpose=SHIP_TYPE_RETUR_SALES,'Rekapitulasi Retur Sales', 'Rekapitulasi Service'));
  ReportTitle := qrlTitle.Caption;
  PreviewModal;
end;

procedure TqrpRekapitulasiSales.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  i:= 1;
end;
...
procedure TqrpRekapitulasiSales.setDetailItem(ARow: integer);
begin
  setClear;
...
procedure TqrpRekapitulasiSales.QuickRepNeedData(Sender: TObject;
...
procedure TqrpRekapitulasiSales.setClear;
begin
...
procedure TqrpRekapitulasiSales.setFrameLable(AState: Boolean);
begin
...
procedure TqrpRekapitulasiSales.setHeader;
begin
...
procedure TqrpRekapitulasiSales.setDetail;
begin
