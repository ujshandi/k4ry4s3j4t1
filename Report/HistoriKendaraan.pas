...
type
  TfrmHistoriKendaraan = class(TForm)
    MainPanel: TPanel;
    pnlFilter: TPanel;
    btnReset: TButton;
    Panel1: TPanel;
  ...
  public
    ...
    function Execute(aPurpose:string;AMenuId:integer):boolean;overload;
    function Execute():boolean;overload;
  end;

var
  frmHistoriKendaraan: TfrmHistoriKendaraan;
...
procedure TfrmHistoriKendaraan.ArrangeColSize;
begin
  case MasterPurpose[1] of
    ESTIMASI_TYPE_1,SHIP_TYPE_SALES,SHIP_TYPE_RETUR_SALES : begin
...
function TfrmHistoriKendaraan.Execute(aPurpose:string;AMenuId:integer): boolean;
begin
 Result := True;
...
procedure TfrmHistoriKendaraan.InitForm;
begin
...
procedure TfrmHistoriKendaraan.InitGrid;
begin
  asgRekap.ExpandAll;
  asgRekap.Clear;
...
procedure TfrmHistoriKendaraan.btnAddClick(Sender: TObject);
begin
  case MasterPurpose[1] of
...
procedure TfrmHistoriKendaraan.btnOkClick(Sender: TObject);
begin
...
procedure TfrmHistoriKendaraan.btnDetailClick(Sender: TObject);
begin
...
procedure TfrmHistoriKendaraan.asgRekapGetAlignment(Sender: TObject; ARow,
...
procedure TfrmHistoriKendaraan.asgRekapDblClickCell(Sender: TObject; ARow,
  ACol: Integer);
begin
  if ARow = 0 then exit;
  btnDetail.Click;
...
procedure TfrmHistoriKendaraan.InitFIlter;
begin
...
procedure TfrmHistoriKendaraan.btnFilterClick(Sender: TObject);
begin
  SetFilterSize(pnlFilter,btnFilter,150);
end;

procedure TfrmHistoriKendaraan.btnResetClick(Sender: TObject);
begin
    InitFIlter;
end;

procedure TfrmHistoriKendaraan.ReloadService;
...
procedure TfrmHistoriKendaraan.ReloadReturService;
var vShipment : TShipment_Arr;
   i,vRow:integer;
...
procedure TfrmHistoriKendaraan.btnPrintClick(Sender: TObject);
...
procedure TfrmHistoriKendaraan.btnDeleteClick(Sender: TObject);
begin
   if cmbTipeLaporan.ItemIndex <> IDX_REKAP then exit;
...
procedure TfrmHistoriKendaraan.ReloadServiceSalesGlobal;
var vRow:integer;
...
procedure TfrmHistoriKendaraan.btnEditClick(Sender: TObject);
begin
   if cmbTipeLaporan.ItemIndex <> IDX_REKAP then exit;
  if asgRekap.Row = 0 then exit;
...
procedure TfrmHistoriKendaraan.ReloadUnitMotor;
...
procedure TfrmHistoriKendaraan.setComboTipeLap;
begin
...
procedure TfrmHistoriKendaraan.ReloadRekapitulasi;
...
procedure TfrmHistoriKendaraan.cmbTipeLaporanDropDown(Sender: TObject);
begin
   SetComboboxSize(cmbTipeLaporan,150);
end;

procedure TfrmHistoriKendaraan.cmbTipeLaporanCloseUp(Sender: TObject);
begin
  SetComboboxSize(cmbTipeLaporan,105);
end;

procedure TfrmHistoriKendaraan.txtNoPolKeyDown(Sender: TObject;
...
procedure TfrmHistoriKendaraan.cmbOpr2Change(Sender: TObject);
begin
   dtpSampai2.Enabled := (cmbOpr2.ItemIndex = 3) and (cmbOpr2.ItemIndex <> 0);
end;

procedure TfrmHistoriKendaraan.chkTglTransClick(Sender: TObject);
begin
  pnlExpr.Enabled := chkTglTrans.Checked;
end;

procedure TfrmHistoriKendaraan.txtKodeKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
var vId:integer;
begin
  if (Key = vk_return) or (Key = vk_tab) then begin
...
procedure TfrmHistoriKendaraan.txtNamaKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
var vId:integer;
begin
  if (Key = vk_return) or (Key = vk_tab) then begin
...
procedure TfrmHistoriKendaraan.ReloadKhusus;
var vShipment : TShipment_Arr;
...
procedure TfrmHistoriKendaraan.ReloadGlobalPart;
var vShipment : TShipment_Arr;
    i,vRow:integer;
  procedure SetFilter;
   begin
...
procedure TfrmHistoriKendaraan.ReloadKhusus2;
var vShipment : TShipment_Arr;
  i,j,vRow,vRow2,vDetailNo:integer;
...
procedure TfrmHistoriKendaraan.ReloadEstimasi;
var vShipment : TShipment_Arr;
   i,vRow:integer;
...
function TfrmHistoriKendaraan.Execute: boolean;
begin
 Result := True;
